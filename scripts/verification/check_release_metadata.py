...
TARGET_CARGO_VERSION = "3.1.4"
TARGET_PYTHON_VERSION = "3.1.4"
# The v3.0.5 banner is intentionally reused for this release.
...
def check(
    *,
    ...
    required = {
        ...
        "docs/releases/v3.1.4.md": f"v{TARGET_PYTHON_VERSION}",
        "mkdocs.yml": "releases/v3.1.4.md",
