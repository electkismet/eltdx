...
def check() -> list[str]:
    errors: list[str] = []
    release = (ROOT / "docs" / "releases" / "v3.0.6.md").read_text(encoding="utf-8")
    ...
    if "## v3.0.6 - 2026-08-28" not in changelog:
        errors.append("changelog does not contain the dated v3.0.6 release")
