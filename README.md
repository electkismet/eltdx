...
| 本地复权系数 | 仅按 `0x000f` 除权除息记录计算的仿射系数 | [`client.corporate.adjustment_factors()`](docs/methods/7709-本地复权系数.md) | `7709 本地计算` |
...
| 本地复权系数 | `client.corporate.adjustment_factors()` | [`0x000f`](docs/COMMANDS_7709.md#cmd-0x000f) | 用标签 `1` 独立计算事件级前/后复权仿射系数 | [文档](docs/methods/7709-本地复权系数.md) |
...
| 当前版本、变更和旧 API 迁移 | [v3.0.4](docs/releases/v3.0.4.md) · [变更记录](docs/CHANGELOG.md) · [迁移说明](docs/MIGRATION_FROM_OLD.md) |
